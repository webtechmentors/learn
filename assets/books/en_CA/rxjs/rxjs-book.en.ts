    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 27,
            "text": "<ul><ul>You should see the output of the subscribed values from the example above.</ul></ul>"
          },
          {
            "paraid": 28,
    ...
    "sections": [
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 4,
            "text": "<ul><ul><li><strong>Emission of Values</strong></li></ul></ul>"
          },
          {
            "paraid": 4,
            "text": "<ul><ul>Observables emit values over time. These values can be of any type, such as numbers, strings, objects, or custom data structures.</ul></ul>"
          },
          {
            "paraid": 5,
            "text": "<ul><ul><li><strong>Completion</strong></li></ul></ul>"
          },
          {
            "paraid": 5,
            "text": "<ul><ul>An observable can complete, indicating that it will no longer emit any more values. This can be useful to signal that a task has finished.</ul></ul>"
          },
          {
            "paraid": 6,
          ...
          {
            "paraid": 6,
            "text": "<ul><ul>Observables can emit errors when something goes wrong in the data stream. This allows you to handle errors gracefully.</ul></ul>"
          },
          {
            "paraid": 7,
          ...
          {
            "paraid": 9,
            "text": "<ul><ul><li><strong>Creating from Data</strong></li></ul></ul>"
          },
          {
            "paraid": 9,
            "text": "<ul><ul>You can create an observable from an array, iterable, or other data structures using the `<code>from</code>` function.</ul></ul>"
          },
          {
            "paraid": 10,
            "text": "<ul><ul><li><strong>Creating from Events</strong></li></ul></ul>"
          },
          {
            "paraid": 10,
            "text": "<ul><ul>Observables can be created from DOM events, node.js events, and more using the `<code>fromEvent</code>` function.</ul></ul>"
          },
          {
            "paraid": 11,
            "text": "<ul><ul><li><strong>Creating Manually</strong></li></ul></ul>"
          },
          {
            "paraid": 11,
            "text": "<ul><ul>You can manually create observables using the `<code>new Observable</code>` constructor and defining how values are emitted, errors are handled, and the observable is completed.</ul></ul>"
          },
          {
            "paraid": 12,
          ...
          {
            "paraid": 18,
            "text": "<ul><ul><li><strong>Cold Observables</strong></li></ul></ul>"
          },
          {
            "paraid": 18,
            "text": "<ul><ul>They start emitting values when a subscription is made. Each subscriber gets its own separate stream of values.</ul></ul>"
          },
          {
            "paraid": 19,
            "text": "<ul><ul><li><strong>Hot Observables</strong></li></ul></ul>"
          },
          {
            "paraid": 19,
            "text": "<ul><ul>They emit values regardless of whether there are subscribers. Subscribers get the values emitted at the time they subscribe. Hot observables are often used for events or data sources that are shared among multiple subscribers.</ul></ul>"
          },
          {
            "paraid": 20,
      ...
      },
      {
        ...
        "paragraphs": [
          {
            "paraid": 1,
            "text": "Subscribing to observables is a critical step in RxJS, as it allows you to start receiving data from the observable's data stream. When you subscribe to an observable, you provide an observer object that defines how to handle emitted values, errors, and the completion of the observable. Here's a detailed explanation of how subscribing to observables works in RxJS:"
          },
          {
            "paraid": 1,
            "text": "<ol><li><strong>Creating an `<code>Observable</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Before you can subscribe to an observable, you first need to have an observable. This can be created in several ways, such as from events, HTTP requests, or custom logic. For example:</ul>"
          },
          {
            "paraid": 17,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Subscribing to the `<code>Observable</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>To start receiving values from the observable, you subscribe to it using the `<code>subscribe()</code>` method. This method takes up to three arguments: handlers for the next value, error, and completion:</ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul><li><strong>Next Handler</strong></li></ul></ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul>A function that handles receiving each value emitted by the observable.</ul></ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul><li><strong>Error Handler</strong></li></ul></ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul>(Optional) A function that handles a potential error emitted by the observable.</ul></ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul><li><strong>Complete Handler</strong></li></ul></ul>"
          },
          {
            "paraid": 1,
            "text": "<ul><ul>(Optional) A function that handles the completion signal from the observable.</ul></ul>"
          },
          {
            "paraid": 17,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul><ul>Or, as a shorthand, you can directly provide the functions as arguments:</ul></ul>"
          },
          {
            "paraid": 17,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Handling Multiple Values</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Observables can emit multiple values over time, and each of these emissions will trigger the next handler in your subscription.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Asynchronous Nature</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Observables can emit values asynchronously, as shown in the initial example where a value is emitted after a timeout.</ul>"
          },
          {
            "paraid": 2,
            "text": "<ol start=\"6\"><li><strong>An Example Subscribing to an Observable</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ol><li><strong>Mapping</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>When a source observable emits a value, `<code>concatMap</code>` applies a function to this value. This function typically returns a new observable (the \"inner observable\"). This is the mapping step, where each source value gets converted into an observable.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Queueing and Flattening</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>`<code>concatMap</code>` maintains the order of emitted values. It subscribes to each inner observable one after the other, in the order they were emitted by the source observable. This means it waits for the current inner observable to complete before subscribing to the next one.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"3\"><li><strong>Sequential Processing</strong></li></ol>"
          },
          {
            "paraid": 5,
            "text": "<ul>The values emitted by the inner observables are merged together into a single output observable. This output observable emits these values in the same order in which they were emitted by the inner observables.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Use Cases</strong></li></ol>"
          },
          {
            "paraid": 13,
            "text": "<ul>Common use cases for `<code>concatMap</code>` include scenarios where you need to perform operations that depend on the order of the values, such as making HTTP requests one at a time in the order they were triggered, or processing data that must maintain a specific order.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Example of `<code>concatMap</code>`</strong></li></ol>"
          },
          {
            "paraid": 7,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 2,
            "text": "<ul>Similar to other mapping operators, `<code>mergeMap</code>` takes each value emitted by the source observable and applies a function to it. This function returns a new observable, referred to as the \"inner observable\". This is the mapping step where each value from the source is transformed into an observable.</ul>"
          },
          {
            "paraid": 3,
            "text": "<ol start=\"2\"><li><strong>Merging</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>`<code>mergeMap</code>` does not preserve the order of the emitted values. Instead, it subscribes to each inner observable as soon as it is created. If multiple inner observables are active at the same time, their emissions are merged into the output observable as they occur.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"3\"><li><strong>Concurrency</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>One of the key features of `<code>mergeMap</code>` is its ability to handle concurrent inner observables. It can subscribe to multiple inner observables simultaneously. This behavior is particularly useful for scenarios where you want to initiate and process multiple asynchronous tasks (like HTTP requests) in parallel.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Overlapping Emissions</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Since `<code>mergeMap</code>` subscribes to inner observables concurrently, it allows their emissions to overlap. This means that the order of emissions in the output observable might not match the order of values emitted by the source observable.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Use Cases</strong></li></ol>"
          },
          {
            "paraid": 12,
            "text": "<ul>Common use cases for `<code>mergeMap</code>` include scenarios where you want to process data concurrently, such as making multiple asynchronous HTTP requests in concurrency or handling events from multiple sources simultaneously.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Example of `<code>mergeMap</code>`</strong></li></ol>"
          },
          {
            "paraid": 6,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ul>`<code>switchMap</code>` starts by taking each value emitted by the source observable and applying a function to it. This function returns an observable, which is the inner observable.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>Switching</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>The key feature of `<code>switchMap</code>` is its switching behavior. Whenever a new value is emitted by the source observable, `<code>switchMap</code>` applies the transformation function to create a new inner observable. It then unsubscribes from the previous inner observable (if there was one) and subscribes to the new inner observable. In essence, it \"switches\" to the latest observable.</ul>"
          },
          {
            "paraid": 5,
            "text": "<ol start=\"3\"><li><strong>Cancellation of Ongoing Observables</strong></li></ol>"
          },
          {
            "paraid": 5,
            "text": "<ul>As a result of this switching, any ongoing emissions from previous inner observables are cancelled. This is especially useful for scenarios where the latest value supersedes any previous values. For example, in the case of a search input where the search query is continuously updated, you're typically only interested in the results of the latest query.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Non-overlapping Emissions</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>`<code>switchMap</code>` ensures that emissions from different inner observables do not overlap. Since it subscribes to only one inner observable at a time, the values emitted to the output observable are always from the most recent inner observable.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Use Cases</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ul>`<code>switchMap</code>` is commonly used in scenarios where only the latest emission is relevant, and any ongoing processes initiated by previous emissions should be cancelled. This is typical in scenarios like type-ahead search suggestions, where the results of the previous search queries become irrelevant as soon as a new query is made.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Example of `<code>switchMap</code>`</strong></li></ol>"
          },
          {
            "paraid": 7,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 4,
            "text": "<ul>`<code>exhaustMap</code>` takes each value emitted by the source observable and applies a function to it. This function typically returns a new observable, known as the inner observable. This is the mapping step where each source value is transformed into an observable.<ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>First Emission Handling</strong></li><ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>When the first value is emitted by the source observable, `<code>exhaustMap</code>` applies the transformation function and subscribes to the resulting inner observable. It begins to emit values from this inner observable to the output.<ul>"
          },
          {
            "paraid": 5,
            "text": "<ol start=\"3\"><li><strong>Ignoring Subsequent Emissions</strong></li><ol>"
          },
          {
            "paraid": 5,
            "text": "<ul>While this first inner observable is still active (i.e., it hasn't completed or errored out), any new values emitted by the source observable are ignored. `<code>exhaustMap</code>` does not subscribe to any new inner observables created from these values. This is the key characteristic that differentiates `<code>exhaustMap</code>` from other flattening operators.<ul>"
          },
          {
            "paraid": 6,
            "text": "<ol start=\"4\"><li><strong>Resumption Post Completion</strong></li><ol>"
          },
          {
            "paraid": 6,
            "text": "<ul>Once the first inner observable completes, `<code>exhaustMap</code>` is ready to handle the next value emitted by the source observable. It will then apply the transformation function to this next value and subscribe to the new inner observable, repeating the process.<ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Use Cases</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ul>`<code>exhaustMap</code>` is particularly useful in scenarios where you want to prevent overlapping processing. For example, it's often used to handle scenarios like button clicks where you don't want to initiate a new process (like an API call) if the previous process triggered by a prior click is still ongoing.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Example of `<code>exhaustMap</code>`</strong></li></ol>"
          },
          {
            "paraid": 8,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ol><li><strong>Delaying Emissions</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>When the source observable emits a value, `<code>debounceTime</code>` starts a timer with a specified duration (in milliseconds). If another value is emitted from the source observable before this timer expires, the timer is reset and starts over with the new value.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>Emitting the Latest Value</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>The value is only sent to the observer if the timer completes without the source observable emitting another value. This means that `<code>debounceTime</code>` effectively ignores all values except the last one emitted before the specified time period elapses.</ul>"
          },
          {
            "paraid": 6,
            "text": "<ol start=\"3\"><li><strong>Repeat Process</strong></li></ol>"
          },
          {
            "paraid": 6,
            "text": "<ul>After emitting a value, `<code>debounceTime</code>` starts the timer again and waits for the debounce time to pass before considering new values.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Use Cases</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ul>ommon use case for `<code>debounceTime</code>` is in search inputs where you want to wait for the user to stop typing before sending a request to the server. This reduces the number of requests made and improves performance.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Example of `<code>debounceTime</code>`</strong></li></ol>"
          },
          {
            "paraid": 8,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ol><li><strong>Initial Emission</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>When the source observable emits a value, `<code>throttleTime</code>` immediately allows this first value to pass through to its output. This is the start of the throttling period.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>Throttling Period</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>After the first value is emitted, `<code>throttleTime</code>` begins a timer for the specified duration (in milliseconds). During this time, any further values emitted by the source observable are ignored.</ul>"
          },
          {
            "paraid": 5,
            "text": "<ol start=\"3\"><li><strong>Next Emission</strong></li></ol>"
          },
          {
            "paraid": 5,
            "text": "<ul>Once the throttling period is over (i.e., the timer expires), the next value emitted by the source observable is allowed through, and a new throttling period begins.</ul>"
          },
          {
            "paraid": 6,
            "text": "<ol start=\"4\"><li><strong>Repeat Process</strong></li></ol>"
          },
          {
            "paraid": 6,
            "text": "<ul>`<code>throttleTime</code>` continues to apply this behavior for each emitted value. If a new value is emitted before the current throttle time window ends, it is ignored. Only the first value within the window is allowed to pass.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Use Cases</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ul>This operator is particularly useful in scenarios where you want to limit the frequency of handling events or actions. A common example is limiting the rate at which a function is called in response to a button click or a scroll event, to avoid performance issues due to rapid firing of events.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Example of `<code>throttleTime</code>`</strong></li></ol>"
          },
          {
            "paraid": 7,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ol><li><strong>Signal Observable</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>The `<code>buffer</code>` operator requires another observable, often referred to as the \"signal observable.\" This signal observable determines when to create a new buffer and emit the collected values.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>Buffer Creation</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>When the signal observable emits a value, a new buffer is created to collect values from the source observable.</ul>"
          },
          {
            "paraid": 5,
            "text": "<ol start=\"3\"><li><strong>Value Collection</strong></li></ol>"
          },
          {
            "paraid": 5,
            "text": "<ul>As values are emitted by the source observable, they are collected into the current buffer until the signal observable emits again.</ul>"
          },
          {
            "paraid": 6,
            "text": "<ol start=\"4\"><li><strong>Buffer Emission</strong></li></ol>"
          },
          {
            "paraid": 6,
            "text": "<ul>When the signal observable emits, the current buffer is emitted as an array to the observer. After emission, a new empty buffer is created to start collecting values again.</ul>"
          },
          {
            "paraid": 7,
            "text": "<ol start=\"5\"><li><strong>Repeat Process</strong></li></ol>"
          },
          {
            "paraid": 7,
            "text": "<ul>The process repeats for each signal emitted by the signal observable. This allows you to collect and process values in batches, where each batch corresponds to the values collected between two signal emissions.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Use Cases</strong></li></ol>"
          },
          {
            "paraid": 15,
            "text": "<ul>Common use cases for the `<code>buffer</code>` operator include scenarios where you want to group data into chunks or batches for processing, such as implementing sliding windows for data analysis, capturing user input within specific time intervals, or managing data streams with variable emission rates.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"7\"><li><strong>Example of `<code>buffer</code>`</strong></li></ol>"
          },
          {
            "paraid": 9,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 3,
            "text": "<ol><li><strong>Boundary Observable</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "<ul>The `<code>window</code>` operator can optionally take another observable as its argument, often referred to as the \"boundary\" observable. This boundary observable determines when to open and close windows. If not provided, the operator uses a timer to open and close windows based on a specified time frame.</ul>"
          },
          {
            "paraid": 4,
            "text": "<ol start=\"2\"><li><strong>Window Creation</strong></li></ol>"
          },
          {
            "paraid": 4,
            "text": "<ul>When the boundary observable emits a signal (or when the timer elapses, in the absence of a boundary observable), a new window is created.</ul>"
          },
          {
            "paraid": 5,
            "text": "<ol start=\"3\"><li><strong>Value Collection</strong></li></ol>"
          ...
          {
            "paraid": 5,
            "text": "<ul>As values are emitted by the source observable, they are collected into the current window until the boundary observable emits again or the timer elapses, indicating the window should close.</ul>"
          },
          {
            "paraid": 6,
            "text": "<ol start=\"4\"><li><strong>Window Emission</strong></li></ol>"
          },
          {
            "paraid": 6,
            "text": "<ul>When the boundary observable emits (or the timer elapses), the current window, containing all the values collected since its creation, is emitted as a new observable to the observer.</ul>"
          },
          {
            "paraid": 7,
            "text": "<ol start=\"5\"><li><strong>Repeat Process</strong></li></ol>"
          ...
          {
            "paraid": 7,
            "text": "<ul>The process repeats for each boundary signal or timer elapse, creating new windows and collecting values accordingly. Each emitted window is an observable that can be subscribed to independently.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Use Cases</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Example of `<code>window</code>`</strong></li></ol>"
          },
          {
            "paraid": 9,
            "text": "",
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          {
            "paraid": 1,
            "text": "RxJS `<code>Subject</code>` is a type of observable that acts as both an observer and an observable. It allows values to be multicasted to multiple subscribers. This is different from plain observables, where each subscribed observer owns an independent execution of the observable."
          },
          {
            "paraid": 1,
            "text": "Here's a basic guide on how to use an RxJS `<code>Subject</code>`:"
          },
          {
            "paraid": 1,
            "text": "<ol><li><strong>Importing `<code>Subject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>First, you need to import `<code>Subject</code>` from the `<code>rxjs</code>` package.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Creating a `<code>Subject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Instantiate a new `<code>Subject</code>`.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"3\"><li><strong>Subscribing Observers</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Observers can subscribe to the `<code>Subject</code>` just like they would with an observable. Each observer will receive the same emitted values.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Emitting Values</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>The `<code>Subject</code>` can emit values using the `<code>next()</code>` method. All subscribers will receive the same value.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Completing the `<code>Subject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>You can complete a `<code>Subject</code>`, signaling that no more values will be emitted, using the `<code>complete()</code>` method.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Error Handling</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>If there’s an error, you can use the `<code>error()</code>` method to emit an error notification to all subscribers.</ul>"
          },
          {
            "paraid": 2,
            "text": "<ol start=\"7\"><li><strong>Example of `<code>Subject</code>`:</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Creating a `<code>BehaviorSubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Instantiate a `<code>BehaviorSubject</code>` with an initial value. This value is emitted to any subscriber upon subscription.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>Observers can subscribe to the `<code>BehaviorSubject</code>` to receive current and future values.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>When a new observer subscribes, it will immediately receive the most recent value from the `<code>BehaviorSubject</code>`.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"4\"><li><strong>Emitting New Values</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>You can emit new values using the `<code>next()</code>` method. All current subscribers will receive these new values.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Getting the Current Value</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>You can get the current value held by the `<code>BehaviorSubject</code>` without subscribing to it, using the `<code>getValue()</code>` method.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Completing the `<code>BehaviorSubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>To signal that no more values will be emitted, you can complete the `<code>BehaviorSubject</code>` using the `<code>complete()</code>` method. This will also complete all its observers.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"7\"><li><strong>Error Handling</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>In case of an error, you can use the `<code>error()</code>` method to emit an error notification to all subscribers. This will also complete the `<code>BehaviorSubject</code>`.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 2,
            "text": "<ol start=\"8\"><li><strong>Example of `<code>BehaviorSubject</code>`:</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Creating a `<code>ReplaySubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>When you instantiate a `<code>ReplaySubject</code>`, you can specify the number of values to replay. Optionally, you can also specify a window time to limit how old the replayed values can be.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>Observers subscribe to the `<code>ReplaySubject</code>` like any other observable. They will receive the last emitted values up to the specified buffer size or within the time window.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>The `<code>ReplaySubject</code>` can emit values using the `<code>next()</code>` method, just like other subjects.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Late Subscriptions</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>If a new observer subscribes later, it will receive the replayed values immediately upon subscription, according to the buffer size or time window specified.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Completing the `<code>ReplaySubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>You can complete a `<code>ReplaySubject</code>` using the `<code>complete()</code>` method, signaling that no more values will be emitted.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>If there's an error, you can use the `<code>error()</code>` method to emit an error notification to all subscribers. This will also complete the `<code>ReplaySubject</code>`.</ul>"
          },
          {
            "paraid": 2,
            "text": "<ol start=\"8\"><li><strong>Example of `<code>ReplaySubject</code>`:</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 1,
            "text": "<ol><li><strong>Importing `<code>AsyncSubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>First, import `<code>AsyncSubject</code>` from the `<code>rxjs</code>` package.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"2\"><li><strong>Creating an `<code>AsyncSubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>Instantiate a new `<code>AsyncSubject</code>`.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>Observers can subscribe to the `<code>AsyncSubject</code>` just like they would with any other observable. However, they won’t receive any values until the `<code>AsyncSubject</code>` completes.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>You can emit values using the `<code>next()</code>` method. Unlike other subjects, these values will not be immediately relayed to the subscribers.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ol start=\"5\"><li><strong>Completing the `<code>AsyncSubject</code>`</strong></li></ol>"
          },
          {
            "paraid": 1,
            "text": "<ul>When the `<code>complete()</code>` method is called on the `<code>AsyncSubject</code>`, it emits the last value it received via `<code>next()</code>` to all of its subscribers, and then completes. No further values can be emitted after this.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 1,
            "text": "<ul>Upon completion, all current subscribers will receive the last value. Any observers that subscribe after the completion will also receive the last value immediately upon subscription.</ul>"
          },
          {
            "paraid": 1,
            "text": "<ol start=\"6\"><li><strong>Error Handling</strong></li></ol>"
          ...
          {
            "paraid": 1,
            "text": "<ul>If the `<code>AsyncSubject</code>` encounters an error by calling the `<code>error()</code>` method, it will emit an error notification to all current and future subscribers and will not emit any value.</ul>"
          },
          {
            "paraid": 3,
            "text": "",
          ...
          {
            "paraid": 2,
            "text": "<ol start=\"7\"><li><strong>Example of `<code>AsyncSubject</code>`:</strong></li></ol>"
          },
          {
            "paraid": 3,
            "text": "",
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          {
            "paraid": 6,
            "text": "<ul><ul><li>Subjects including `<code>Subject</code>`, `<code>BehaviorSubject</code>`, `<code>ReplaySubject</code>`, and `<code>AsyncSubject</code>` are special types of observables that are also observers. They act as bridges or proxies that can multicast values to multiple subscribers.</li></ul></ul>"
          },
          {
            "paraid": 7,
          ...
          {
            "paraid": 9,
            "text": "<ul><ul><li>Create a subject of your choice (e.g., `<code>Subject</code>`, `<code>BehaviorSubject</code>`, etc.).</li></ul></ul>"
          },
          {
            "paraid": 10,
            "text": "<ul><ul><li>Subscribe your subject to the source observable you want to multicast.</li></ul></ul>"
          },
          {
            "paraid": 11,
            "text": "<ul><ul><li>Subscribe multiple observers to the subject.</li></ul></ul>"
          },
          {
            "paraid": 12,
            "text": "<ul><ul><li>The values emitted by the source observable are now multicast to all subscribers of the subject.</li></ul></ul>"
          },
          {
            "paraid": 13,
          ...
          {
            "paraid": 14,
            "text": "<ul><ul><li>Efficient resource usage: Multicasting can save resources by sharing a single execution stream.</li></ul></ul>"
          },
          {
            "paraid": 15,
            "text": "<ul><ul><li>Avoiding redundant work: Some operations, such as making HTTP requests, can be costly, and multicasting helps avoid redundancy.</li></ul></ul>"
          },
          {
            "paraid": 16,
            "text": "<ul><ul><li>Sharing data among multiple subscribers: Multicasting is essential when you need to broadcast data or events to multiple consumers.</li></ul></ul>"
          },
          {
            "paraid": 17,
