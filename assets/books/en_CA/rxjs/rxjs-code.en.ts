...
export const rxjs_2_3_4 =
`const subscription = observable.subscribe(x => console.log(x));
// Later:
subscription.unsubscribe();`;

export const rxjs_2_3_5 =
`import { Observable } from 'rxjs';
...
export const rxjs_2_3_5_1 = getOutput(
  ['const { Observable } = rxjs;'],
  rxjs_2_3_5
);
...
export const rxjs_5_2_2 =
`const subject = new Subject();`;

export const rxjs_5_2_3 =
"subject.subscribe(data => console.log(`Observer 1: ${data}`)); \n\
subject.subscribe(data => console.log(`Observer 2: ${data}`));";

export const rxjs_5_2_4 =
`subject.next('Hello');
subject.next('World');`;

export const rxjs_5_2_5 =
`subject.complete();`;

export const rxjs_5_2_6 =
`subject.error(new Error('Something went wrong'));`;

export const rxjs_5_2_7 =
"import { Subject } from 'rxjs'; \n\
\n\
...
export const rxjs_5_2_7_1 = getOutput(
  ['const { Subject } = rxjs;'],
  rxjs_5_2_7
);
...
export const rxjs_5_3_2 =
`const behaviorSubject = new BehaviorSubject('Initial Value');`;

export const rxjs_5_3_3 =
"behaviorSubject.subscribe(value => console.log(`Observer 1: ${value}`));";

export const rxjs_5_3_4 =
`behaviorSubject.next('New Value');`;

export const rxjs_5_3_5 =
`const currentValue = behaviorSubject.getValue();`;

export const rxjs_5_3_6 =
`behaviorSubject.complete();`;

export const rxjs_5_3_7 =
`behaviorSubject.error(new Error('An error occurred'));`;

export const rxjs_5_3_8 =
`import { BehaviorSubject } from 'rxjs';
...
export const rxjs_5_3_8_1 = getOutput(
...
export const rxjs_5_4_2 =
`// This will replay the last 3 values to new subscribers
const replaySubject = new ReplaySubject(3);

// This will replay the last 2 values within a 500ms time window
const timedReplaySubject = new ReplaySubject(2, 500);`;

export const rxjs_5_4_3 =
"replaySubject.subscribe(data => console.log(`Observer 1: ${data}`));";

export const rxjs_5_4_4 =
`replaySubject.next('Value 1');
replaySubject.next('Value 2');
replaySubject.next('Value 3');`;

export const rxjs_5_4_5 =
"// This new observer will receive the last 3 values immediately. \n\
replaySubject.subscribe(data => console.log(`Observer 2: ${data}`));";

export const rxjs_5_4_6 =
`replaySubject.complete();`;

export const rxjs_5_4_7 =
`replaySubject.error(new Error('Something went wrong'));`;

export const rxjs_5_4_8 =
`import { ReplaySubject } from 'rxjs';
...
export const rxjs_5_4_8_1 = getOutput(
...
export const rxjs_5_5_2 =
`const asyncSubject = new AsyncSubject();`;

export const rxjs_5_5_3 =
"asyncSubject.subscribe(value => console.log(`Observer 1: ${value}`));";

export const rxjs_5_5_4 =
`asyncSubject.next('First Value');
asyncSubject.next('Second Value');`;

export const rxjs_5_5_5 =
`asyncSubject.complete();`;

export const rxjs_5_5_6 =
`asyncSubject.error(new Error('Something went wrong'));`;

export const rxjs_5_5_7 =
`import { AsyncSubject } from 'rxjs';
...
export const rxjs_5_5_7_1 = getOutput(
